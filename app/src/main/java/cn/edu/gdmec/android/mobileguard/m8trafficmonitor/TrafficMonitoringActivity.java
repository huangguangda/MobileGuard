...
public class TrafficMonitoringActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_triffic_monito);
        ...
        if( !SystemInfoUtils.isServiceRunning( this,"cn.edu.gdmec.mobileguard" +
                ".mB8trafficmonitor.service.TrafficMontoringService")){
    ...
    private class CorrectFlowReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            for (Object obj : objs){
                ...
                mUsedTV.setText("本月可用:" + Formatter.formatFileSize(context,(used + beyond)));
            }
        }
    }
